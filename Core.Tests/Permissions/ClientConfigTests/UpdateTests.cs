    ...
    public class UpdateTests
    {
        ...
        public async Task UpdateClientConfig_NonOrgUser_False()
        {
            ...
            mockClientConfigRepository
                .Setup(repo =>
                    repo.Update(It.IsAny<Guid>(), It.IsAny<ClientConfig>()))
            ...
            MockOutputPort<UpdateClientConfigResponse> mockOutputPort =
                new MockOutputPort<UpdateClientConfigResponse>();
            ...
            bool response = await useCase.HandleAsync(
                new UpdateClientConfigRequest(userId.ToString(), Guid.NewGuid(), Guid.NewGuid(), new List<Guid>(),
                    new List<Guid>()), mockOutputPort);
        ...
        public async Task UpdateClientConfig_CorrectPermission_True(OrganisationPermissions permission)
        {
            ...
            Mock<IClientConfigRepository> mockClientConfigRepository = new Mock<IClientConfigRepository>();
            mockClientConfigRepository
                .Setup(repo => repo.Update(It.IsAny<Guid>(), It.IsAny<ClientConfig>()))
                .Callback(() => updateRan = true)
                .ReturnsAsync(new UpdateClientConfigGatewayResponse(mockClientConfig, true));
            mockClientConfigRepository
                .Setup(repo => repo.Get(It.IsAny<Guid>()))
